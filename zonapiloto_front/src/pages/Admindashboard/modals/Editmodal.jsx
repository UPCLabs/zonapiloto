...
const EditModal = ({
    ...
    const handleSubmit = (e) => {
        ...
        if (editModal.type === "calendar") {
            ...
            handleUpdate("/information/institutional-events", editModal.data.id, data);
            ...
            handleUpdate("/information/announcements-photos", editModal.data.id, formDataToSend);
            ...
            handleUpdate("/information/question-bank/questions", editModal.data.questionId, data);
        } else if (editModal.type === "category") {
            data = {
                name: formData.get("name"),
                description: formData.get("description"),
            };
            handleUpdate("/information/question-bank/categories", editModal.data.categoryId, data);
                    ...
                    {editModal.type === "question" && (
                        <>
                            ...
                            <div className="form-group">
                                ...
                                <select name="categoryName" defaultValue={editModal.data?.categoryName} required>
