...
import "../../styles/components/privacidad.css";
                ...
                <div className="privacidad-content">
                    <section className="privacy-section">
                        ...
                        <p>
                            ...
                            Esto incluye información de registro como nombre, dirección de correo electrónico, número de teléfono
                            y cualquier otra información que decida compartir con nosotros.
                        </p>
                    ...
                    <section className="privacy-section">
                        ...
                        <p>
                            ...
                            procesar transacciones, enviar comunicaciones importantes y personalizar su experiencia en nuestra plataforma.
                        </p>
                        <div className="info-box">
                    ...
                    <section className="privacy-section">
                        ...
                        <p>
                            No vendemos, alquilamos ni compartimos su información personal con terceros para sus propósitos
                            de marketing sin su consentimiento explícito. Podemos compartir información en las siguientes circunstancias:
                        </p>
                    ...
                    <section className="privacy-section">
                        ...
                        <p>
                            ...
                            personal contra acceso no autorizado, alteración, divulgación o destrucción. Utilizamos encriptación
                            SSL/TLS para todas las transmisiones de datos sensibles.
                        </p>
                    </section>
                    ...
                    <section className="privacy-section">
                        ...
                        <p>
                            ...
                            También puede oponerse al procesamiento de su información personal u optar por no recibir comunicaciones
                            de marketing.
                        </p>
                        <div className="highlight-box">
                            ...
                            <ul>
                                ...
                                <li><strong>Oposición:</strong> Objetar ciertos procesamientos de datos</li>
                            </ul>
                        </div>
                    </section>
                    ...
                    <section className="privacy-section">
                        ...
                        <p>
                            ...
                            sitio web y personalizar contenido. Puede gestionar sus preferencias de cookies a través de la
                    ...
                    <section className="privacy-section contact-section">
                        ...
                        <div className="contact-info">
                            <p><strong>Email:</strong> privacidad@ejemplo.com</p>
