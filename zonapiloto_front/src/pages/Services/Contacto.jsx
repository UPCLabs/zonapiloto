...
const Contact = () => {
    ...
    return (
        <div className="contact-container">
            ...
            <p className="subtitle">Conoce a los profesionales detrás del proyecto</p>
                ...
                {teamMembers.map((member) => (
                    ...
                    >
                        ...
                        <div className="member-info">
                            ...
                            <div className={`contact-details ${selectedMember === member.id ? 'show' : ''}`}>
                            ...
                            <button className="toggle-btn">
                                {selectedMember === member.id ? 'Ocultar contacto' : 'Ver contacto'}
                            </button>
                        </div>
                    </div>
                ))}
